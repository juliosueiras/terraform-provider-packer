...
func AmazonInstanceResource() *schema.Resource {
...
"bundle_destination": &schema.Schema{
Optional: true,
			Type: schema.TypeString,

		},

"bundle_prefix": &schema.Schema{
Optional: true,
			Type: schema.TypeString,

		},

"bundle_upload_command": &schema.Schema{
Optional: true,
			Type: schema.TypeString,

		},

"bundle_vol_command": &schema.Schema{
Optional: true,
			Type: schema.TypeString,
...
"x509_cert_path": &schema.Schema{
Optional: true,
			Type: schema.TypeString,

		},

"x509_key_path": &schema.Schema{
Optional: true,
			Type: schema.TypeString,

		},

"x509_upload_path": &schema.Schema{
Optional: true,
			Type: schema.TypeString,
